...
func TestWithdrawals(t *testing.T) {
	...
	input := uint64(100_000000)    // 100 ADA
	fee := uint64(100000)          // 0.1 ADA
	reward := uint64(122000)       // 0.122 ADA
	output := input - fee + reward // 100.022 ADA
	...
	txIn := NewTxInput(txHashIn, 0, NewValue(Coin(input)))
	txOut := NewTxOutput(addrOut, NewValue(Coin(output)))

	txBuilder := NewTxBuilder(alonzoProtocol)

	txBuilder.AddInputs(txIn)
	txBuilder.AddOutputs(txOut)
	txBuilder.SetWithdrawals(stakeAddr, Coin(reward))
	...
	if got, want := hex.EncodeToString(txBytes), ""; got != want {
